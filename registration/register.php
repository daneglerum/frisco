<?php get_header( 'buddypress' ); ?>
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div class="register-section" id="blog-details-section">
						...
						<p><input type="checkbox" checked="checked" name="signup_with_blog" id="signup_with_blog" value="1"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes, I\'d like to create a new site', 'buddypress' ); ?></p>
	...
	// hide the blog details if they don't want a blog
		...
		// Set the blog domain to the username as you type
		jQuery('#signup_username').keyup(function() {
			  jQuery('#signup_blog_url').val(this.value);
			});
